...
public class MockServiceTest {
    ...
    public void 로직2번(){
        ...
        midchampion.setHasSkinCount(3);
        mockChampions.add(midchampion);
        System.out.println("name :: "+topchampion.getName());
        System.out.println("name :: "+topchampion.getName());
    ...
    public void 이름저장(){
        ...
        verify(topchampion,never()).setName(anyString());
    ...
    public void 시간안에(){
        ...
        topchampion.setHasSkinCount(3);
        System.out.println("name :: "+topchampion.getName());
        verify(topchampion,timeout(200).times(1)).getName();
    ...
    public void 갯수맞나(){
        ...
        mockChampions.add(new Champion("티모","미드",4));
    ...
    @Test
    public void 가짜챔피언(){
        when(mockService.findByName(any(String.class))).thenReturn(new Champion("리산드라","미드",4));
        assertThat(mockService.findByName("조이").getHasSkinCount(),is(4));
        verify(mockRepository,times(1)).findByName(anyString());
    }
    ...
    public void 여러개(){
        ...
        champions.add(new Champion("우디르","미드",3));
